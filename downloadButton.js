...
var UAMatchStrings = {
  'Win64': 'https://github.com/minbrowser/min/releases/download/v1.18.1/min-1.18.1-setup.exe',
  'WOW64': 'https://github.com/minbrowser/min/releases/download/v1.18.1/min-1.18.1-setup.exe',
  ...
  'Windows NT': 'https://github.com/minbrowser/min/releases/download/v1.18.1/min-1.18.1-setup.exe'
}
