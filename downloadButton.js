...
var platformMatchStrings = {
  MacIntel: 'https://github.com/minbrowser/min/releases/download/v1.19.0/Min-v1.19.0-darwin-x64.zip',
  ...
  // 'Linux aarch64': 'https://github.com/minbrowser/min/releases/download/v1.19.0/min_1.19.0_armhf.deb',
  ...
  Linux: {
    ...
    deb: 'https://github.com/minbrowser/min/releases/download/v1.19.0/min_1.19.0_amd64.deb',
    rpm: 'https://github.com/minbrowser/min/releases/download/v1.19.0/min-1.19.0-1.x86_64.rpm'
  }
}

// matches against navigator.userAgent
var UAMatchStrings = {
  Win64: 'https://github.com/minbrowser/min/releases/download/v1.19.0/min-1.19.0-setup.exe',
  WOW64: 'https://github.com/minbrowser/min/releases/download/v1.19.0/min-1.19.0-setup.exe',
  ...
  'Windows NT': 'https://github.com/minbrowser/min/releases/download/v1.19.0/min-1.19.0-setup.exe'
}
