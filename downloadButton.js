...
var platformMatchStrings = {
  'MacIntel': 'https://github.com/minbrowser/min/releases/download/v1.17.1/Min-v1.17.1-darwin-x64.zip',
  ...
  'Linux aarch64': 'https://github.com/minbrowser/min/releases/download/v1.17.1/min_1.17.1_armhf.deb',
  ...
  'Linux': {
    ...
    deb: 'https://github.com/minbrowser/min/releases/download/v1.17.1/min_1.17.1_amd64.deb',
    rpm: 'https://github.com/minbrowser/min/releases/download/v1.17.1/min-1.17.1-1.x86_64.rpm'
  }
}

// matches against navigator.userAgent
var UAMatchStrings = {
  'Win64': 'https://github.com/minbrowser/min/releases/download/v1.17.1/min-1.17.1-setup.exe',
  'WOW64': 'https://github.com/minbrowser/min/releases/download/v1.17.1/min-1.17.1-setup.exe',
  ...
  'Windows NT': 'https://github.com/minbrowser/min/releases/download/v1.17.1/min-1.17.1-setup.exe'
}
