...
var downloadLinks = {
  mac: {
    intel: 'https://github.com/minbrowser/min/releases/download/v1.21.0/Min-v1.21.0-darwin-x64.zip',
    arm: 'https://github.com/minbrowser/min/releases/download/v1.21.0/Min-v1.21.0-darwin-arm64.zip'
  },
  linux: {
    deb: 'https://github.com/minbrowser/min/releases/download/v1.21.0/min_1.21.0_amd64.deb',
    rpm: 'https://github.com/minbrowser/min/releases/download/v1.21.0/min-1.21.0-1.x86_64.rpm'
  },
  windows: 'https://github.com/minbrowser/min/releases/download/v1.21.0/min-1.21.0-setup.exe'
}
