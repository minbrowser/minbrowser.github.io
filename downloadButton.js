...
var downloadLinks = {
  mac: {
    intel: 'https://github.com/minbrowser/min/releases/download/v1.25.1/min-v1.25.1-mac-x86.zip',
    arm: 'https://github.com/minbrowser/min/releases/download/v1.25.1/min-v1.25.1-mac-arm64.zip'
  },
  linux: {
    deb: 'https://github.com/minbrowser/min/releases/download/v1.25.1/min-1.25.1-amd64.deb',
    rpm: 'https://github.com/minbrowser/min/releases/download/v1.25.1/min-1.25.1-x86_64.rpm'
  },
  windows: 'https://github.com/minbrowser/min/releases/download/v1.25.1/min-1.25.1-setup.exe'
}
