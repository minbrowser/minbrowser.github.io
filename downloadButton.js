...
var downloadLinks = {
  mac: {
    intel: 'https://github.com/minbrowser/min/releases/download/v1.34.0/min-v1.34.0-mac-x86.zip',
    arm: 'https://github.com/minbrowser/min/releases/download/v1.34.0/min-v1.34.0-mac-arm64.zip'
  },
  linux: {
    deb: 'https://github.com/minbrowser/min/releases/download/v1.34.0/min-1.34.0-amd64.deb',
    rpm: 'https://github.com/minbrowser/min/releases/download/v1.34.0/min-1.34.0-x86_64.rpm'
  },
  windows: 'https://github.com/minbrowser/min/releases/download/v1.34.0/min-1.34.0-setup.exe'
}
